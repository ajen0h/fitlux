    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http.authorizeHttpRequests(auth ->
                ...
                auth.requestMatchers(HttpMethod.GET,"/api/users").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT,"/api/avisos/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/api/avisos/{id}").hasRole("ADMIN")
                        //DEPORTES
                        .requestMatchers(HttpMethod.GET,"/api/deportes","/api/deportes/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/deportes").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/deportes/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/api/deportes/{id}").hasRole("ADMIN")
                .anyRequest()
                .authenticated()
