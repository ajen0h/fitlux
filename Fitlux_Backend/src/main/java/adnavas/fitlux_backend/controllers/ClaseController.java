...
public class ClaseController {
    ...
    public ResponseEntity<?> listClassUsers(@PathVariable String idClase) {
        ...
        if (claseFound != null) {
            List<Usuario> usuarios = claseService.listarUsuariosClase(claseFound.getUsuarios());
    ...
    public ResponseEntity<String> register(@RequestParam String idClase) {
    ...
    public ResponseEntity<String> unregister(@RequestParam String idClase) {
        ObjectId objectIdClase = new ObjectId(idClase);
